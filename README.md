...
Upgrade behavior is intentionally preview-first: run `runectx upgrade` to review the plan and `runectx upgrade apply` only when you are ready to mutate local project files.
