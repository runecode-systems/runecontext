...
These fixtures exercise the strict alpha.3 traceability foundation for `changes/`, `standards/`, `specs/`, and `decisions/`.
...
- `standards/**/*.md`, `specs/*.md`, and `decisions/*.md` use YAML frontmatter with IDs that must match the path-relative stem.
