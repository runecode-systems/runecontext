...
## Proposed Change
Generate documentation-facing command, capability, compatibility, and layout reference surfaces from the canonical metadata builder, establish Docus-friendly structured inputs, and clean up stale assumptions about the in-repo operations reference.
...
## Assumptions
- Docus pages can render generated JSON or YAML reference data while keeping narrative prose hand-authored.
