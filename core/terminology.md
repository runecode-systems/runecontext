...
| `operations reference` | The generated docs-consumption reference surface derived from canonical metadata, stored at `docs/reference/generated/runecontext-reference.json`. |
